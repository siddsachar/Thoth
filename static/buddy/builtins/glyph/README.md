...
Custom Hatch Buddies can still generate user-local packs, but supported first-party packs live in the repo under `static/buddy/builtins/` so fresh installs have an animated Buddy without any model calls at runtime.
