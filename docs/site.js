(() => {
    ...
    const WINDOWS_URL = 'https://github.com/siddsachar/row-bot/releases/download/v4.9.1/Row-Bot-4.9.1-Windows-x64.exe';
    const MAC_URL = 'https://github.com/siddsachar/row-bot/releases/download/v4.9.1/Row-Bot-4.9.1-macOS-arm64.dmg';
    const LINUX_COMMAND = 'curl -fsSL https://raw.githubusercontent.com/siddsachar/row-bot/main/installer/install-linux.sh | bash -s -- 4.9.1';
