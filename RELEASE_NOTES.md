...
- **Hatch save recovery** — saving Buddy settings now preserves freshly generated Hatch art and motion pointers instead of falling back to the selected bundled pack, offers a motion-only retry for generated still art, and new motion requests use provider-compatible 5-second clips.
