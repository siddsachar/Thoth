...
Voice and Buddy make Row-Bot feel less like a text box and more like a desktop companion. Voice handles speech input and optional spoken output. Buddy reflects app state and can be docked in the sidebar or torn off into a compact desktop overlay.
...
- **Drag to tear off** moves Buddy from its sidebar dock into the native desktop overlay.
- **Dock Buddy** in the overlay menu returns it to the sidebar.
- Tear-off is session-scoped; restarting Row-Bot returns Buddy to its normal sidebar dock.
- The overlay follows the selected thread and shares its stream, drafts, tools, and approvals.
