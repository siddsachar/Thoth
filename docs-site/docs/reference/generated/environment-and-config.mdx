...
| ROW_BOT_ALLOWED_HOSTS | Allow exact HTTP Host authorities accepted by the access gate. | `src/row_bot/access/cli.py, src/row_bot/access/config.py, src/row_bot/access/diagnostics.py, src/row_bot/app.py` |
...
| ROW_BOT_BROWSER_HEADLESS | Run bundled browser automation without an interactive display. | `src/row_bot/tools/browser_tool.py` |
