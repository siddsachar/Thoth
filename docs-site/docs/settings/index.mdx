...
- **System** configures Remote Access, workspace boundaries, window behavior, tunnels, logs, and diagnostics.
...
4. Skills
5. System access and, only when needed, [Remote Access](/docs/operations/remote-access)
